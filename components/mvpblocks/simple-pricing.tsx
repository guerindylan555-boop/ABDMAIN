...
const plans = [
  {
    ...
    features: [
      ...
      'Formulaires, Enquêtes, Calendriers, Newsletter',
      'Tableaux de bord, Devis',
      'Support basic inclus, Chat quotidien',
      'Formations & Tutoriels en autonomie (mise à jour continue)',
      'Rapports avancés (Pubs, CRM, Opportunités, RDV, Appels)',
    ],
    cta: 'Choisir Starter',
  },
  {
